...
def generate_launch_description():
    ...
    # Process XACRO
    xacro_path = os.path.join(get_package_share_directory('robomuse'), 'urdf', 'robomuse.xacro')
    ...
    rviz = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', os.path.join(get_package_share_directory('robomuse'), 'rviz', 'entire_setup.rviz')]
    )
